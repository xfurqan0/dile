...
//! be the file reader and the form. This is that package: the struct below is what
//! `<app config>/settings.json` holds, [`store`] is how a running application finds out that
//! it changed, and [`commands`] is how the settings window asks.
//!
